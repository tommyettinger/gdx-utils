...
public class MathUtils {
	...
	/**
	 * Calculates the sum of a number's digits. If {@code n} is negative, this
	 * will produce a negative result; otherwise, the result will be non-negative.
	 *
	...
	/**
	 * Non-recursive integer factorial.
	 * This only really makes sense to use for {@code n} between 1 and 12, inclusive.
	 * Larger inputs will produce incorrect results due to overflow; the correct factorial for n=13
	 * and greater cannot be stored in an {@code int}.
	 * If n is negative, this throws an IllegalArgumentException.
	 *
	 * @param n the int to find the factorial for
